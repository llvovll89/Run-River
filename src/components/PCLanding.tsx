...
const BROWSERS = [
    {
        ...
        icon: (
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                ...
                />
                <path
                    d="M8.5 8.5 L15.5 15.5 M15.5 8.5 L12 12"
                    stroke="#007aff"
                    strokeWidth="1.8"
                    strokeLinecap="round"
                />
        ...
        steps: ["하단 공유 버튼(□↑) 탭", '"홈 화면에 추가" 선택', '"추가" 탭'],
    },
    {
        name: "Chrome (Android)",
        color: "#34a853",
    ...
    },
    {
        ...
        icon: (
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                <path
                    d="M21 8C21 5.2 18.8 3 16 3 C10 3 5 8 5 14 C5 18.4 8.6 22 13 22 C16 22 19 20.2 20.5 17.5"
                    stroke="#0078d4"
                    strokeWidth="1.8"
                    strokeLinecap="round"
                />
                <path
                    d="M3 14 C3 14 6 10 12 10 C16.4 10 19 12 19 12"
                    stroke="#0078d4"
                    strokeWidth="1.8"
                    strokeLinecap="round"
                />
    ...
    },
    {
        ...
        icon: (
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                ...
                />
                <path
                    d="M12 3 C8 3 5 6 5 10 C5 14 8 17 12 17 C16 17 19 14 19 10"
                    stroke="#ff7139"
                    strokeWidth="1.8"
                    strokeLinecap="round"
                />
                <path
                    d="M12 17 C12 17 14 15 14 12 C14 9 12 8 12 8"
                    stroke="#ff7139"
                    strokeWidth="1.8"
                    strokeLinecap="round"
                />
...
export default function PCLanding() {
    ...
    useEffect(() => {
        // 모바일 전용 앱이므로 PC 랜딩에서는 서버 통계를 비필수로 처리
    }, []);
            ...
            >
                ...
                >
                    <p style={{fontSize: 12, color: "rgba(255,255,255,0.18)"}}>
                        PC에서는 기록 조회만 가능합니다 · 실제 활동은 모바일에서
                        이용해주세요
                    </p>
                    <p style={{fontSize: 12, color: "rgba(255,255,255,0.18)"}}>
                        Run River
